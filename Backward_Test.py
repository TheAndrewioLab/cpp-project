...
def move_backward(vehicle, distance):
    """
    Move the vehicle backward by a specified distance.
    """
    current_location = vehicle.location.global_relative_frame
    # Calculate the new location backward
    new_location = get_location_metres(current_location, -distance, 0)
...
# Example usage: Move the drone 5 meters backward
move_backward(vehicle, 5)
